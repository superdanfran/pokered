...
BrockData:
	db $FF, 15, GOLEM, 15, KABUTO, 15, OMANYTE, 15, AERODACTYL, 0

MistyData:
	db $FF, 26, VAPOREON, 26, POLIWRATH, 26, DEWGONG, 26, STARMIE, 0

LtSurgeData:
	db $FF, 39, ELECTRODE, 39, MAGNETON, 39, PORYGON, 39, JOLTEON, 39, ELECTABUZZ, 39, RAICHU, 0

ErikaData:
	db $FF, 54, VILEPLUME, 54, CLEFABLE, 54, VENUSAUR, 54, TANGELA, 54, VICTREEBEL, 54, EXEGGUTOR, 0

KogaData:
	db $FF, 66, VENOMOTH, 66, WEEZING, 66, MR_MIME, 66, NIDOKING, 66, GENGAR, 66, TENTACRUEL, 0

BlaineData:
	db $FF, 84, CHARIZARD, 84, CHANSEY, 84, RAPIDASH, 84, FLAREON, 84, MAGMAR, 84, MOLTRES, 0

SabrinaData:
	db $FF, 75, JYNX, 75, SLOWBRO, 75, HYPNO, 75, EXEGGUTOR, 75, STARMIE, 75, ALAKAZAM, 0
