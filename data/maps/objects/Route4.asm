...
Route4_Object:
	...
	bg_event 46, 11, TEXT_ROUTE4_SIGN

	def_object_events
	object_event 14,  5, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_ROUTE4_COOLTRAINER_F1
	object_event 63,  3, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE4_COOLTRAINER_F2, OPP_LASS, 4
	object_event 74, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE4_TM_WHIRLWIND, TM_WHIRLWIND
