...
CeladonMart2FClerk2Text::
	script_mart TM_DIG, TM_REFLECT, TM_RAZOR_WIND, TM_HORN_DRILL, TM_EGG_BOMB, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SUBMISSION
...
CeladonMart5FClerk2Text::
	script_mart TM_DOUBLE_EDGE, TM_SEISMIC_TOSS, TM_TELEPORT, TM_SWIFT, TM_PSYWAVE, TM_TRI_ATTACK
