...
ViridianMartClerkText::
	script_mart POKE_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, MASTER_BALL, MAX_REPEL
...
CeladonMart4FClerkText::
	script_mart POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, MOON_STONE, SUN_STONE, ICE_STONE
